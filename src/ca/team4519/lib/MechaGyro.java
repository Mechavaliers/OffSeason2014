 ...
 */
public class MechaGyro extends SensorBase implements PIDSource, ISensor, LiveWindowSendable {
  ...
  .
    ...
    */
  public MechaGyro(int slot, int channel) {
  ...
  /**
    ...
    */
  public MechaGyro(AnalogChannel channel) {
    m_analog = channel;
    if (m_analog == null) {
