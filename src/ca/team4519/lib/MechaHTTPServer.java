...
import ca.team4519.lib.util.HtmlResponse;
import ca.team4519.lib.util.Util;
...
public class MechaHTTPServer implements Runnable {
  ...
  public MechaHTTPServer() {
    PORT = 41234;
    connections = new Vector();
  }

  public MechaHTTPServer(int port) {
    PORT = port;
    connections = new Vector();
  }
